...
void ExecutaLogicaDruidFeralPvPOFF(Player* botPlayer, Unit*& victim, BotRole /*rolBot*/)
{
...
void ExecutaLogicaPriestDiscPvPOFF2(Player* botPriest, Unit*& victim, BotRole rolBot)
{
