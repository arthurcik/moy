...
#ifndef TRINITYSERVER_CHATLOG_H
#define TRINITYSERVER_CHATLOG_H
...
class ChatLog
{
    ...
    public:
        ...
        void GuildMOTDLog(Guild* guild, std::string const& msg, bool isBlocked);
        bool CheckMOTDLexics(std::string& msg);
