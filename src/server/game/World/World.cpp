...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_KITT_WHO_MESSAGE_ENABLED] = sConfigMgr->GetBoolDefault("Kitt.WHO.msg.enable", false);
    ...
    m_int_configs[CONFIG_UINT32_WHO_COUNT_BASE] = sConfigMgr->GetIntDefault("WhoCountBase", 0);
    ...
    // kitt Prevent players AFK from being logged out
