...
struct TC_GAME_API Loot
{
    ...
    ObjectGuid sourceGuid; // kitt
    bool FillLoot(uint32 lootId, LootStore const& store, Player* lootOwner, bool personal, bool noEmptyError = false, uint16 lootMode = LOOT_MODE_DEFAULT, ObjectGuid sGuidLoot = ObjectGuid::Empty); // kitt adaugare
